...
def generate_timetable(timetable_id: str) -> GenerationOutcome:
    """
    ...
    logger.info(
        "Timetable %s generation complete: %d entries, %d conflicts",
...
def detect_conflicts(timetable_id: str) -> List[ConflictRecord]:
