...
urlpatterns = [
    ...
    path('years/<int:pk>/edit/', views.AcademicYearUpdateView.as_view(), name='academic_year_edit'),
    path('years/<int:pk>/delete/', views.AcademicYearDeleteView.as_view(), name='academic_year_delete'),
    ...
    path('class-levels/<int:pk>/edit/', views.ClassLevelUpdateView.as_view(), name='class_level_edit'),
    ...
    path('sections/<int:pk>/edit/', views.ClassSectionUpdateView.as_view(), name='class_section_edit'),
    path('sections/<int:pk>/delete/', views.ClassSectionDeleteView.as_view(), name='class_section_delete'),
    ...
    path('assignments/<int:pk>/edit/', views.TeacherAssignmentUpdateView.as_view(), name='teacher_assignment_edit'),
